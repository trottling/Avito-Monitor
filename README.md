Без проблем, сделаю README, который будет максимально инфо-апгрейднутый: с учетом старой версии, новыми параметрами, описанием модулей и примерами, сохранив твой стиль и читаемость.
Дальше можно просто копировать в гит, telegram или лить прямо в release.
